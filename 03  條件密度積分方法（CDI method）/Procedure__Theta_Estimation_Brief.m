...
Path_Output = fullfile(Path_MainFolder, 'Code', '03  輸出圖片');


%% Plot: with Cubic B-Spline Curve

% Define Color of Each Line
color_All = ['b'; 'g'; 'm'; 'c'; 'y'; 'k'; 'r'];

Cubic_BSpline_Basis_Functions_Curve = figure;
...
g_function_value = sum(transpose(theta_hat) .* y_BS, 1);
...
% Add Title
title(['Cubic B-Spline Basis Functions and Curve for ' num2str(current_month) ' (b = ' num2str(b) ')'], ...
      'FontSize', 15, ...
...
filename = ['Cubic_BSpline_Basis_Functions_Curve (b=' num2str(b) ').png'];
saveas(Cubic_BSpline_Basis_Functions_Curve, fullfile(Path_Output, filename));
clear filename


%% Plot: without Cubic B-Spline Curve

% Define Color of Each Line
color_All = ['b'; 'g'; 'm'; 'c'; 'y'; 'k'; 'r'];

Cubic_BSpline_Basis_Functions = figure;
...
% Add Title
title(['Cubic B-Spline Basis Functions for ' num2str(current_month) ' (b = ' num2str(b) ')'], ...
      'FontSize', 15, ...
      'FontName', 'Times New Roman', ...
      'FontWeight', 'Bold')
...
filename = ['Cubic_BSpline_Basis_Functions (b=' num2str(b) ').png'];
saveas(Cubic_BSpline_Basis_Functions, fullfile(Path_Output, filename));
clear filename
